...
production = {
    ...
    "Pel" : general.kata_benda + general.proper_noun + general.kata_ganti + ["NPNoun", "NPAdj", "NPPropNoun", "NPPronoun", "NumPNP"] + general.kata_sifat + ["AdvAdjP"] + general.numeralia + ["NumPNum", "NumPNoun"] + general.kata_kerja + ["AdvVP"] + ["PrepNP"] + ["NPVP"],
